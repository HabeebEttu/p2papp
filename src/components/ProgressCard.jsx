      ...
      <div className="space-y-4">
        <div>
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm font-medium text-gray-700">Current XP</span>
            <span className="text-sm text-gray-600">2450 / 3000</span>
          </div>
          <div
            aria-valuemax="100"
            aria-valuemin="0"
...
>
  <div
    ...
    style={{ transform: "translateX(-18.3333%)" }}
  ></div>
</div>

          <p className="mt-1 text-xs text-gray-500">550 XP to next rank</p>
        </div>
